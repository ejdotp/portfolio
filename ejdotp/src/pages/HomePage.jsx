        ...
        <div className="space-y-12">
            <section id="aboutme" className="mb-16 scroll-mt-24">
                <div className="flex flex-col md:flex-row gap-8 items-start">
                    {/* Rectangular and Boxy Profile Picture */}
                    <img
                        src="/images/1.jpg"
                        alt="E. Jagadeeswar Patro"
                        className="w-40 h-48 md:w-64 md:h-64 object-cover rounded-sm shadow-md flex-shrink-0"
                        onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/160x192/EFEFEF/333333?text=E.J.P' }}
                    />
                    <div className="font-sans text-base leading-relaxed space-y-4">
            ...
            <Section id="cocurricular" title="Co-curricular Work">
                <div className="flex flex-col md:flex-row gap-5 items-start">
                    ...
                    {/* Rectangular Photo Space for Co-curricular */}
